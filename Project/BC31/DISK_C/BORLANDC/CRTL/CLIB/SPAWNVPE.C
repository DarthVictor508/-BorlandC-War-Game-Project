 ...
 *
 * function(s)
 *        spawnvpe - creates and runs child processes
 *-----------------------------------------------------------------------*/
...
Name            spawnvpe - creates and runs child processes

Usage           #include <process.h>
                int spawnvpe(int modeF, char *pathP, char *argv[],
                             char *envP[]);
...
int spawnvpe(int modeF, char *pathP, char *argv[], char *envV[])
{
        ...
        {
        case P_WAIT :
                return _LoadProg(_spawn, pathP, argv, envV, 1);
        case P_OVERLAY :
