...
void init(int(*map_type)[13 + 3], struct unit my[], struct unit en[]) {
	...
	for (i = 1; i <= 14; i++){
		...
		en[2].max_move=0;
		en[2].max_attack=2;
		en[2].x[1]=320+5; en[2].y[1]=40+20;
		en[2].x[2]=280+5;en[2].y[2]=80+20;     en[2].x[3]=320+5;en[2].y[3]=80+20;
		en[2].x[4]=240+5;en[2].y[4]=120+20;    en[2].x[5]=280+5;en[2].y[5]=120+20;  en[2].x[6]=320+5;en[2].y[6]=120+20;
		en[2].x[7]=280+5;en[2].y[7]=160+20;    en[2].x[8]=400+5;en[2].y[8]=160+20;
		en[2].x[9]=240+5;en[2].y[9]=200+20;    en[2].x[10]=280+5;en[2].y[10]=200+20;  en[2].x[11]=320+5;en[2].y[11]=200+20;
		en[2].x[12]=280+5;en[2].y[12]=240+20;  en[2].x[13]=320+5;en[2].y[13]=240+20;
		en[2].x[14]=320+5;en[2].y[14]=280+20;
		...
		en[2].a[7] = 8; en[2].b[7] = 5;    en[2].a[8] = 11; en[2].b[8] = 5;
	...
	for (i = 1; i <= 8; i++) {
		...
		en[3].max_move=0;
		en[3].max_attack=0;
		en[3].x[1]=360+5;en[3].y[1]=80+20;  en[3].x[2]=400+5;en[3].y[2]=80+20;
		en[3].x[3]=360+5;en[3].y[3]=120+20;
		en[3].x[4]=240+5;en[3].y[4]=160+20; en[3].x[5]=360+5;en[3].y[5]=160+20;
		en[3].x[6]=360+5;en[3].y[6]=200+20;
		en[3].x[7]=360+5;en[3].y[7]=240+20; en[3].x[8]=400+5;en[3].y[8]=240+20;
